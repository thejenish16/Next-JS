...
export default function EditCarPage() {
    ...
    const [formCarData, setFormCarData] = useState<formCarDataType>({
        id: 0, carName: "", carModel: "", carPrice: 0, carBrand: "", carColor: [], carFuel: ""
    });
    ...
    useEffect(() => {
        ...
        if (carData) setFormCarData(carData);
    }, []);
    ...
    const onSubmit = (event: any) => {
        ...
        allCars = allCars.map(car => car.id === Number(id) ? formCarData : car);
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-10 px-4">
            <div className="max-w-xl mx-auto">
                ...
                <div className="mb-8">
                    <p className="text-orange-500 text-xs font-bold uppercase tracking-widest mb-2">Edit</p>
                    <h1 className="text-3xl font-black text-gray-900 mb-1">Edit Car Details</h1>
                    <p className="text-gray-400 text-sm">Update the information for this car.</p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 space-y-5">
                    ...
                    <button type="submit" onClick={onSubmit}
                        className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-3.5 rounded-xl transition-all duration-200 text-sm shadow-md shadow-orange-200 mt-2">
                        Update Car Details
                    </button>
                </div>
            </div>
